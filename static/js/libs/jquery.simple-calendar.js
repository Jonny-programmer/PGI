    ...
    $.extend(Plugin.prototype, {
        init: function () {
            ...
            var header = $('<header>' +
                ...
                '<a class="simple-calendar-btn btn-prev2" href="#"></a>' +
                '<a class="simple-calendar-btn btn-next2" href="#"></a>' +
                '</header>');
        ...
        bindEvents: function () {
            ...
            $(plugin.element).on('click', '.btn-prev2', function (e) {
                plugin.changeMonth(-12)
                e.preventDefault();
            });
            ...
            $(plugin.element).on('click', '.btn-next2', function (e) {
                plugin.changeMonth(12);
                e.preventDefault();
            });
